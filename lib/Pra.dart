...
Pra praFromJson(String str) => Pra.fromJson(json.decode(str));

String praToJson(Pra data) => json.encode(data.toJson());
...
class Pra {
  ...
  factory Pra.fromJson(Map<String, dynamic> json) => Pra(
    code: json["code"],
    status: json["status"],
